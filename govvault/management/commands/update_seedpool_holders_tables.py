...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if to_block_number:
            ...
            update_seedpool_holders_tables(from_block_number, to_block_number)
        else:
            print('to latest block')
            update_seedpool_holders_tables(from_block_number)

        self.stdout.write('Finished Seed Pool update command')